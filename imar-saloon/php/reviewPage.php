...
<head>
    ...
    <title>Ulasan - Imar Saloon</title>
...
<body>
    <header>
        ...
        <nav class="links">
            ...
            <a href="../php/reviewPage.php" class="active">Ulasan</a>
    ...
    <main class="review-page-main">
        <section class="review-hero">
            <div class="section-header">
                <span class="sub-title">Pengalaman Pelanggan</span>
                <h2>Apa Kata Mereka</h2>
                <div class="divider"></div>
                <p class="review-intro">Kami berkomitmen untuk memancarkan kecantikan Anda. Baca ulasan jujur dari pelanggan setia kami di Google.</p>
            </div>
        </section>

        <section class="review-widget-section">
            <div class="widget-wrapper">
                <!-- Trustindex Google Reviews Grid Widget -->
                <script defer async src='https://cdn.trustindex.io/loader.js?2d2666076ccc6960fa36100a9c6'></script>
            </div>
        </section>
